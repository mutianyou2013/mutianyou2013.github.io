...
The market price per ton of ammonia for the current state-of-the-art Haber-Bosch process is stable at around $600, while the price to produce one ton of ammonia by the complex system varied with the performance of the catalytic reaction. To achieve a breakeven price, the required faradaic efficiency (FE) for the nitrogen electro-reduction to ammonia catalytic reaction is around 42%.  
